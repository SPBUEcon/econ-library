...
Оригиналы презентаций — **приватные деки Д. Хан**, в репозиторий не копируются (личные, крупные).
В каталоге хранятся только структурированные извлечения. Текст извлечён 2026-09-24 (python-pptx).
